...
namespace PLZASeedFinderPlugin.Helpers;
...
public static class WinFormsUtil
{
    ...
    public static DialogResult Alert(params string[] lines)
    {
        ...
        return MessageBox.Show(msg, "PLZA Seed Finder", MessageBoxButtons.OK, MessageBoxIcon.Information);
    }
    ...
    public static DialogResult Error(params string[] lines)
    {
        ...
        string msg = string.Join(Environment.NewLine + Environment.NewLine, lines);
        return MessageBox.Show(msg, "PLZA Seed Finder - Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
    }
}
